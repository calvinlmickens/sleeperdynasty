...
def main():
    ...
    p.add_argument("--finalize-week", action="store_true", help="Write an immutable final weekly matchup snapshot")
    p.add_argument("--pregame-context", default=None, help="Last pregame weekly_matchup_context.csv used to preserve lineup and projections")
    ...
    result = run_refresh(
        ...
        finalize_week=args.finalize_week,
        pregame_context=args.pregame_context,
    )
